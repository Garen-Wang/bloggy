use actix_web::web;
use crate::handler::{get_blog_article_by_name, get_static_image, get_main_homepage, get_blog_homepage, get_blog_archives, get_static_css, get_static_js, get_favicon};
